#include "../../code/common/scheduler.h"
...
void test_fiber1() {
     ...
     */
    myriel::Scheduler::GetThis()->schedule(myriel::Fiber::GetThis());
...
void test_fiber4() {
    ...
    for (int i = 0; i < 3; i++) {
        myriel::Scheduler::GetThis()->schedule(test_fiber5, std::this_thread::get_id());
    }
...
int main() {
    ...
    myriel::Fiber::ptr fiber(new myriel::Fiber(&test_fiber3));
    sc.schedule(fiber);
